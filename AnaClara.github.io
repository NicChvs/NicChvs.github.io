    ...
    <div class="page-header page-header-small" filter-color="green">
      ...
      <div class="container">
        <div class="content-center">
          <div class="cc-profile-image"><a href="#"><img src="nicolepfp.jpg" alt="Image"/></a></div>
          <div class="h2 title">Ana Clara de Freitas Furtado</div>
          <p class="category text-white">Student, Developer</p><a class="btn btn-primary smooth-scroll mr-2" href="#contact" data-aos="zoom-in" data-aos-anchor="data-aos-anchor">Hire Me</a><a class="btn btn-primary" href="#" data-aos="zoom-in" data-aos-anchor="data-aos-anchor">Download CV</a>
        </div>
      </div>
      <div class="section">
        <div class="container">
      ...
      <div class="row">
        <div class="col-lg-6 col-md-12">
          <div class="card-body">
            ...
            <p>Olá! Meu nome é Ana Clara. Sou uma pessoa criativa, cristã e que gosta de ajudar as pessoas.</p>
          </div>
        </div>
        <div class="col-lg-6 col-md-12">
          <div class="card-body">
            ...
            <div class="row">
              ...
              <div class="col-sm-8">15 anos</div>
            </div>
            <div class="row mt-3">
            ...
            <div class="row mt-3">
              ...
              <div class="col-sm-8">Hortolândia, SP, Brasil</div>
            </div>
            <div class="row mt-3">
  ...
  <div class="container cc-education">
    ...
    <div class="card">
      <div class="row">
        ...
        <div class="col-md-9" data-aos="fade-left" data-aos-offset="50" data-aos-duration="500">
          <div class="card-body">
            <div class="h5">Aulas de Inglês</div>
              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class="card-body">
                    ...
                    <p class="pb-2">Rua Ricardo Aparecido Pinto, nº557, Bairro Vila Real</p>
                    <p class="mb-0"><strong>Telefone</strong></p>
                    <p class="pb-2">+55 (19)98394-7394</p>
                    <p class="mb-0"><strong>Email</strong></p>
                    <p>nicolechavesdadda2@gmail.com</p>
                  </div>
                </div>
              </div>
            </div>
